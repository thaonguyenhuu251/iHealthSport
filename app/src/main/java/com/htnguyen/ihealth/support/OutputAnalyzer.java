...
public class OutputAnalyzer {
    private final MeasureHeartBeatActivity activity;
    ...
    public OutputAnalyzer(MeasureHeartBeatActivity activity, TextureView graphTextureView, Handler mainHandler) {
    ...
    public void measurePulse(TextureView textureView, CameraService cameraService) {
        ...
        timer = new CountDownTimer(measurementLength, measurementInterval) {
            ...
            public void onFinish() {
                ...
                sendMessage(MeasureHeartBeatActivity.MESSAGE_UPDATE_FINAL, returnValueSb.toString());

                cameraService.stop();
            }
        };

        activity.setViewState(MeasureHeartBeatActivity.VIEW_STATE.MEASUREMENT);
        timer.start();
    }
