...
import com.htnguyen.ihealth.BuildConfig.MAPS_API_KEY
import com.htnguyen.ihealth.R
import com.htnguyen.ihealth.databinding.ActivityGpsMapBinding
import com.htnguyen.ihealth.model.Route
import com.htnguyen.ihealth.network.ApiInterface
        ...
        when(requestCode){
            PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION -> {
                ...
                if(grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED){
                    ...
                    val intentUserSetup = Intent(this, MainActivity::class.java)
